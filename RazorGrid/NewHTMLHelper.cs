...
namespace System.Web.Mvc
{
    public class NewHTMLHelper
    {
        ...
        public NewHTMLHelper(ViewContext viewContext, IViewDataContainer viewDataContainer)
            : this(viewContext, viewDataContainer, RouteTable.Routes)
        {
        }

        public NewHTMLHelper(ViewContext viewContext, IViewDataContainer viewDataContainer, RouteCollection routeCollection)
        {
            if (viewContext == null)
            {
        ...
        {
            get { return WebPages.Html.NewHTMLHelper.IdAttributeDotReplacement; }
            set { WebPages.Html.NewHTMLHelper.IdAttributeDotReplacement = value; }
        }
        ...
        public MvcHtmlString HttpMethodOverride(HttpVerbs httpVerb)
        {
            ...
            switch (httpVerb)
            {
                ...
                case HttpVerbs.Options:
                    ...
                    break;
                default:
                    throw new ArgumentException(MvcResources.NewHTMLHelper_InvalidHttpVerb, "httpVerb");
            }
        ...
        public MvcHtmlString HttpMethodOverride(string httpMethod)
        {
            ...
            {
                throw new ArgumentException(MvcResources.NewHTMLHelper_InvalidHttpMethod, "httpMethod");
            }
